...
grep -nE "UI build 2026-09-18-BOARDUX|Leads ·|Drop on a status" deploy/web-dist-v3/main.dart.js | head -3
...
grep -n "UI build 2026-09-18-BOARDUX" backend/public/app-v3/main.dart.js | head -1
...
Expect: UI build 2026-09-18-BOARDUX
Board: Lead ID on cards; filtered status hides empty columns; drop chips for move
EOF
