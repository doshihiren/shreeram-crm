...
grep -nE "UI build 2026-08-14-DRAGALL|Leads ·|Drag to another status" deploy/web-dist-v3/main.dart.js | head -3
...
grep -n "UI build 2026-08-14-DRAGALL" backend/public/app-v3/main.dart.js | head -1
...
Expect: UI build 2026-08-14-DRAGALL
Board: drag lead cards between status columns (all leads load — not 50)
On drop: remarks + next follow-up date
