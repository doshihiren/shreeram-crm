...
grep -nE "UI build 2026-09-18-INTEREST|wa.me|WhatsApp" deploy/web-dist-v3/main.dart.js | head -5
...
grep -n "UI build 2026-09-18-INTEREST" backend/public/app-v3/main.dart.js | head -1
...
Expect: UI build 2026-09-18-INTEREST
Board cards show BHK/Shop + budget chips from lead / Meta form answers
EOF
