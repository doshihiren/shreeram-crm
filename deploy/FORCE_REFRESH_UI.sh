...
grep -nE "UI build 2026-08-14-STAGESFIX|Leads ·|Continue as" deploy/web-dist-v3/main.dart.js | head -3
...
grep -n "UI build 2026-08-14-STAGESFIX" backend/public/app-v3/main.dart.js | head -1
