...
class SyncLeadPipeline extends Command
{
    ...
    public function handle(): int
    {
        ...
        // Keep names distinct — do NOT keep both "Call Not Received" and "Call Note received".
        $pipeline = [
        ...
        DB::transaction(function () use ($pipeline) {
            ...
            $map = [
                'CONTACTED' => 'CALL_DONE',
                'CALL_NOTE_RECEIVED' => 'CALL_DONE', // removed — looked like a duplicate of Call Not Received
                'INTERESTED' => 'CALL_DONE',
